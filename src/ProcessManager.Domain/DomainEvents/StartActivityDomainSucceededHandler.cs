...
{
    public class StartActivityDomainSucceededHandler : INotificationHandler<StartActivityDomainSucceeded>
    {
        ...
        public StartActivityDomainSucceededHandler(IUnitOfWork unitOfWork, IContextAccessor contextAccessor, IMapper mapper)
        {
        ...
        public async Task Handle(StartActivityDomainSucceeded notification, CancellationToken cancellationToken)
        {
            var @event = _mapper.Map<StartActivitySucceeded>(notification);
