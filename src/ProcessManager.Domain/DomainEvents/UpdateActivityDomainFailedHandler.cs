...
{
    public class UpdateActivityDomainFailedHandler : INotificationHandler<UpdateActivityDomainFailed>
    {
        ...
        public UpdateActivityDomainFailedHandler(IUnitOfWork unitOfWork, IContextAccessor contextAccessor, IMapper mapper)
        {
        ...
        public async Task Handle(UpdateActivityDomainFailed notification, CancellationToken cancellationToken)
        {
            var @event = _mapper.Map<UpdateActivityFailed>(notification);
