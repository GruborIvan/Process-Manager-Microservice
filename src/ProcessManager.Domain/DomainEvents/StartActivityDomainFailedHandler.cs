...
{
    public class StartActivityDomainFailedHandler : INotificationHandler<StartActivityDomainFailed>
    {
        ...
        public StartActivityDomainFailedHandler(IUnitOfWork unitOfWork, IContextAccessor contextAccessor, IMapper mapper)
        {
        ...
        public async Task Handle(StartActivityDomainFailed notification, CancellationToken cancellationToken)
        {
            var @event = _mapper.Map<StartActivityFailed>(notification);
